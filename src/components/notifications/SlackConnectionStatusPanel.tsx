import { Alert, Box, Button, Card, Link as MuiLink, Stack, Typography } from '@mui/material'
...
export default function SlackConnectionStatusPanel({
  ...
  const workspaceLink = hasValidTeamDomain ? `https://${teamDomain}.slack.com` : undefined

  const channelLink =
    hasValidTeamDomain && integration?.channelId
