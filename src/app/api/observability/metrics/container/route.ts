// BFF 프록시: GET /api/observability/metrics/container
// dashboard → observability-service /v1/metrics/container
...
export async function GET(request: Request) {
  ...
  const upstream = `${BASE_URL}/v1/metrics/container?${searchParams.toString()}`
