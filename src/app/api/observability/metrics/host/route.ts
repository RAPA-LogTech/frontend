// BFF 프록시: GET /api/observability/metrics/host
// dashboard → observability-service /v1/metrics/host
...
export async function GET(request: Request) {
  ...
  const upstream = `${BASE_URL}/v1/metrics/host?${searchParams.toString()}`
