// BFF 프록시: GET /api/observability/metrics/database
// dashboard → observability-service /v1/metrics/databases
...
export async function GET(request: Request) {
  ...
  const upstream = `${BASE_URL}/v1/metrics/databases?${searchParams.toString()}`
