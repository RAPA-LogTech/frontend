// BFF 프록시: GET /api/observability/metrics/latency
// dashboard → observability-service /v1/metrics/latency
...
export async function GET(request: Request) {
  ...
  const upstream = `${BASE_URL}/v1/metrics/latency?${searchParams.toString()}`
